            ...
            >
                <div className="[perspective:1000px]">
                    <div
                        ...
                        className="relative cursor-pointer transition-transform hover:-translate-x-0.5 hover:-translate-y-0.5 outline-none focus-visible:ring-2 focus-visible:ring-amber-400"
                    >
                        <div
                            className={`relative w-full min-h-[300px] ${isFlipped ? 'min-h-[400px]' : ''} bg-white dark:bg-stone-900 border-2 border-amber-500 dark:border-amber-400 shadow-[8px_8px_0px_0px_rgba(245,158,11,1)] dark:shadow-[8px_8px_0px_0px_rgba(245,158,11,0.2)] transition-transform duration-500 [transform-style:preserve-3d] ${
                        ...
                        >
                            ...
                            <div className="p-6 bg-white dark:bg-stone-900 [backface-visibility:hidden] [-webkit-backface-visibility:hidden]">
                                ...
                                <button
                                    ...
                                    className="mt-4 w-full flex items-center justify-center gap-2 bg-stone-900 dark:bg-amber-400 text-white dark:text-stone-900 py-3 border-2 border-stone-900 font-heading font-black text-xs uppercase tracking-widest hover:bg-amber-500 transition-all"
                                >
                                    Explore Listing
